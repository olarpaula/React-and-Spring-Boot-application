...
class MyBasket extends React.Component {
    ...
    deleteFromBasket = (product_id) => {
        ...
        axiosInstance.put("/user/deleteProductFromBasket", dto)
            .then(
                res => {
                    const val = res.data;
                    console.log(val);        
                        ...
                        <Link underline='none' >
                            ...
                            />
                                ...
                                <CardActions style={{justifyContent: 'center'}}>
                                    ...
                                    <IconButton aria-label="add to basket" onClick = {() => this.deleteFromBasket(product.id)}> <RemoveShoppingCartIcon /> </IconButton>
...
export default withStyles(styles)(MyBasket);
